...
Thanks!';
    ...
    public static function fetch_endpoint_update_ekballo_url(): string
    {
        return trailingslashit(site_url()) . 'wp-json/disciple_tools_magic_links/v1/update_ekballo_url';
    }
